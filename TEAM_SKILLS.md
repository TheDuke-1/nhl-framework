...
- Execution planning (`/project:plan`)
- End-to-end implementation (`/project:build`)
- Fast bug resolution (`/quick-fix`)

## Engineering Quality Skills
- Deep code review (`code-reviewer`, `/project:code-review`)
- Complexity reduction (`code-simplifier`)
- Test design and verification (`test-engineer`, `verify-app`, `/project:verify`)

## Design and Product Skills
- Design vision direction (`creative-director`)
- UI polish (`ui-designer`)
- UX flows and IA (`ux-designer`)
- Motion quality (`motion-designer`)
- Accessibility compliance (`accessibility`)
- Visual QA and regression checks (`visual-qa`)
- Design system governance (`design-system`)

## Process and Framework Skills
- Discovery interviews (`/interview`, `/design-interview`, `/design-audit`)
- Session continuity (`/session-start`, `/session-end`)
